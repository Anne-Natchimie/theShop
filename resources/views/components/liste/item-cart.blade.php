<div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
    <div class="md:w-4/12 2xl:w-1/4 w-full">
        ...
        <div class="flex items-center justify-between w-full">
            ...
            <select id="{{$itemCart->id}}" aria-label="Select quantity" class="cartChangeQuantity py-2 px-1 border border-gray-200 mr-6 focus:outline-none dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-white">
        ...
        <div class="flex items-center justify-between pt-5">
            ...
            <p class="text-base font-black leading-none text-gray-800 dark:text-white"> {{$itemCart->product->price}} € </p>
        </div>
    </div>
</div>
